...
def process(file_i_path, file_i):
    ...
    cv2.imwrite("./dst_bee/bee2/"+str(file_i)[:-4]+"-test1.jpg", rot1)
    cv2.imwrite("./dst_bee/bee2/"+str(file_i)[:-4]+"-test2.jpg", rot2)
    cv2.imwrite("./dst_bee/bee2/"+str(file_i)[:-4]+"-test3.jpg", rot3)
    ...
    cv2.imwrite("./dst_bee/bee2/"+str(file_i)[:-4]+"-test4.jpg", rot1)
    cv2.imwrite("./dst_bee/bee2/"+str(file_i)[:-4]+"-test5.jpg", rot2)
    ...
    cv2.imwrite("./dst_bee/bee2/"+str(file_i)[:-4]+"-test6.jpg", move1)
    cv2.imwrite("./dst_bee/bee2/"+str(file_i)[:-4]+"-test7.jpg", move2)
    ...
    img_Brightness.save("./dst_bee/bee2/"+str(file_i)[:-4]+"-test8.jpg")
    img_contrasted.save("./dst_bee/bee2/"+str(file_i)[:-4]+"-test9.jpg")
    img_pepper_salt.save("./dst_bee/bee2/"+str(file_i)[:-4]+"-test10.jpg")
